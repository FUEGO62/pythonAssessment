...
def DisplayMenu():
	...
	userInput =int(input("Thank you for purchasing the Nokia phone please access our wide range of features! \n1-> Phone book\n2-> Messages\n3-> Chat\n4-> Call register\n5-> Tones\n6-> Settings\n7-> Call divert\n8-> Games\n9-> Calculator\n10-> Reminders\n11-> Clock\n12-> Profiles\n13-> SIM services\nEnter 99 to go back\n"))
...
def Options():
	...
	userInput = int(input("1->Type of view\n2->Memory Status\n"))
